...
async function seedDefaultProducts() {
  try {
    // ⚠️ THIS IS THE FIX: This forces MongoDB to delete the old 35 items so all 137 can load!
    await Product.deleteMany({});
    
    const imgs = [
        'https://images.unsplash.com/photo-1593482834166-d34559eb4e1c?w=500', // 0: Indoor
        'https://images.unsplash.com/photo-1592841200221-a689c1f07441?w=500', // 1: Indoor
        'https://images.unsplash.com/photo-1632207188724-18a22ec24765?w=500', // 2: Indoor
        'https://images.unsplash.com/photo-1614594975525-e45190c55d0b?w=500', // 3: Indoor
        'https://images.unsplash.com/photo-1611211232932-da3113c5b960?w=500', // 4: Indoor
        'https://images.unsplash.com/photo-1501004318641-b39e6451bec6?w=500', // 5: Indoor
        'https://images.unsplash.com/photo-1615967963246-77ae8419c86e?w=500', // 6: Outdoor/Flowers
        'https://images.unsplash.com/photo-1599598425838-8040b81f13f6?w=500', // 7: Outdoor/Flowers
        'https://images.unsplash.com/photo-1542838132-92c53300491e?w=500', // 8: Outdoor/Flowers
        'https://images.unsplash.com/photo-1588610344406-444747c3cfd1?w=500', // 9: Outdoor/Flowers
        'https://images.unsplash.com/photo-1553279768-865429fa0078?w=500', // 10: Fruits
        'https://images.unsplash.com/photo-1533038590840-1cde6e668a91?w=500', // 11: Fruits
        'https://images.unsplash.com/photo-1536510233921-8e1043f0c33e?w=500', // 12: Fruits
        'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=500', // 13: Seeds
        'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500', // 14: Seeds
        'https://images.unsplash.com/photo-1606851094090-827236dc9969?w=500'  // 15: Seeds
    ];
    ...
    const defaultProducts = [
      ...
      {id:'p41', name:'Red Rose', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[7]},
      {id:'p42', name:'Pink Rose', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[7]},
      {id:'p43', name:'White Rose', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[8]},
      {id:'p44', name:'Hibiscus Red', category:'Flowering Plants', price:149, origPrice:193, bestSeller:false, image:imgs[7]},
      {id:'p45', name:'Hibiscus Yellow', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[7]},
      {id:'p46', name:'Hibiscus Pink', category:'Flowering Plants', price:149, origPrice:193, bestSeller:false, image:imgs[9]},
      {id:'p47', name:'Mogra', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[6]},
      {id:'p48', name:'Jasmine', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[6]},
      {id:'p49', name:'Bougainvillea', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[7]},
      {id:'p50', name:'Adenium', category:'Flowering Plants', price:299, origPrice:388, bestSeller:false, image:imgs[9]},
      {id:'p51', name:'Plumeria', category:'Flowering Plants', price:249, origPrice:323, bestSeller:false, image:imgs[7]},
      {id:'p52', name:'Ixora', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[9]},
      {id:'p53', name:'Gardenia', category:'Flowering Plants', price:249, origPrice:323, bestSeller:false, image:imgs[6]},
      {id:'p54', name:'Chrysanthemum', category:'Flowering Plants', price:59, origPrice:76, bestSeller:false, image:imgs[9]},
      {id:'p55', name:'Marigold', category:'Flowering Plants', price:49, origPrice:63, bestSeller:false, image:imgs[8]},
      {id:'p56', name:'Portulaca', category:'Flowering Plants', price:49, origPrice:63, bestSeller:false, image:imgs[6]},
      {id:'p57', name:'Aparajita', category:'Flowering Plants', price:149, origPrice:193, bestSeller:false, image:imgs[9]},
      {id:'p58', name:'Rangoon Creeper', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[8]},
      {id:'p59', name:'Gerbera', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[9]},
      {id:'p60', name:'Kalanchoe', category:'Flowering Plants', price:199, origPrice:258, bestSeller:false, image:imgs[6]},
      ...
      {id:'p81', name:'Marigold', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[14]},
      {id:'p82', name:'Rose', category:'Flower Seeds', price:79, origPrice:102, bestSeller:false, image:imgs[13]},
      {id:'p83', name:'Hibiscus', category:'Flower Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[13]},
      {id:'p84', name:'Petunia', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[15]},
      {id:'p85', name:'Zinnia', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[15]},
      {id:'p86', name:'Sunflower', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[13]},
      {id:'p87', name:'Cosmos', category:'Flower Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[15]},
      {id:'p88', name:'Portulaca', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[15]},
      {id:'p89', name:'Snapdragon', category:'Flower Seeds', price:69, origPrice:89, bestSeller:false, image:imgs[14]},
      {id:'p90', name:'Calendula', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[13]},
      {id:'p91', name:'Aster', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[14]},
      {id:'p92', name:'Dahlia', category:'Flower Seeds', price:69, origPrice:89, bestSeller:false, image:imgs[13]},
      {id:'p93', name:'Celosia', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[15]},
      {id:'p94', name:'Dianthus', category:'Flower Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[13]},
      {id:'p95', name:'Chrysanthemum', category:'Flower Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[15]},
      {id:'p96', name:'Balsam', category:'Flower Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[14]},
      {id:'p97', name:'Morning Glory', category:'Flower Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[14]},
      {id:'p98', name:'Sweet Pea', category:'Flower Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[14]},
      {id:'p99', name:'Nasturtium', category:'Flower Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[14]},
      {id:'p100', name:'Gomphrena', category:'Flower Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[14]},
      ...
      {id:'p107', name:'Cucumber', category:'Vegetable Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[13]},
      {id:'p108', name:'Bottle Gourd', category:'Vegetable Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[15]},
      {id:'p109', name:'Bitter Gourd', category:'Vegetable Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[15]},
      {id:'p110', name:'Ridge Gourd', category:'Vegetable Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[15]},
      {id:'p111', name:'Pumpkin', category:'Vegetable Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[14]},
      {id:'p112', name:'Beans', category:'Vegetable Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[14]},
      {id:'p113', name:'Peas', category:'Vegetable Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[13]},
      {id:'p114', name:'Carrot', category:'Vegetable Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[15]},
      {id:'p115', name:'Radish', category:'Vegetable Seeds', price:29, origPrice:37, bestSeller:false, image:imgs[14]},
      {id:'p116', name:'Beetroot', category:'Vegetable Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[13]},
      {id:'p117', name:'Spinach', category:'Vegetable Seeds', price:29, origPrice:37, bestSeller:false, image:imgs[15]},
      {id:'p118', name:'Coriander', category:'Vegetable Seeds', price:29, origPrice:37, bestSeller:false, image:imgs[13]},
      ...
      {id:'p121', name:'Cauliflower', category:'Vegetable Seeds', price:39, origPrice:50, bestSeller:false, image:imgs[14]},
      {id:'p122', name:'Broccoli', category:'Vegetable Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[14]},
      {id:'p123', name:'Onion', category:'Vegetable Seeds', price:29, origPrice:37, bestSeller:false, image:imgs[13]},
      {id:'p124', name:'Watermelon', category:'Fruit Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[13]},
      {id:'p125', name:'Muskmelon', category:'Fruit Seeds', price:49, origPrice:63, bestSeller:false, image:imgs[15]},
      {id:'p126', name:'Papaya', category:'Fruit Seeds', price:59, origPrice:76, bestSeller:false, image:imgs[13]},
      {id:'p127', name:'Strawberry', category:'Fruit Seeds', price:79, origPrice:102, bestSeller:false, image:imgs[13]},
      {id:'p128', name:'Dragon Fruit', category:'Fruit Seeds', price:99, origPrice:128, bestSeller:false, image:imgs[15]},
      {id:'p129', name:'Passion Fruit', category:'Fruit Seeds', price:79, origPrice:102, bestSeller:false, image:imgs[15]},
